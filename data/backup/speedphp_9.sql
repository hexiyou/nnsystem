...
INSERT INTO `nn_admin` VALUES (3,0,'xninfo','07037df431085a1dc1a0505d2d5bae26','abcdef','xninfo@163.com','13812342022',1462354542,1462354542,1462354542,'127.0.0.1','127.0.0.1',100,0),(2,0,'admin','c7935cc8ee50b752345290d8cf136827','abcdef','hackkey@qq.com','15587210592',708393600,1462351247,1462351247,'127.0.0.1','127.0.0.1',100,0),(8,0,'test02','37922e3787a12cb2ad33099ab74f60fd','Cimd3F','123456@qq.com','15587210592',2012,1463543782,NULL,'127.0.0.1',NULL,100,0),(7,0,'admin5','8bce6c4babf4db8deea21929e42eb468','uYggRt','hackkey@qq.com','15587210592',2012,1463543685,NULL,'127.0.0.1',NULL,100,0);
...
CREATE TABLE `nn_admin_group` (
  ...
  `list_order` int(4) NOT NULL DEFAULT '100',
  `rules` varchar(500) NOT NULL DEFAULT '' COMMENT '用户组拥有的规则id，多个规则 , 隔开',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='用户组定义表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `nn_admin_group` VALUES (0,0,'超级管理员','超级管理员',1,100,''),(5,0,'ssf','sfsfsf',1,200,''),(4,0,'ssf','sfsfsf',1,0,'');
...
-- Dump completed on 2016-05-18 15:41:29
